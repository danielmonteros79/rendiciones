...
<html>
    ...
    <body>
        ...
        <logic:notPresent name="messageModifTCJP">
            ...
            <html:form action="aprobacionesSend" styleId="RechazarRendicionForm" method="post" onsubmit="redirect(window.opener);">
                    ...
                    <tbody>
                        <tr>
                            <td style="width:130px;"> 
                                <label for="motivo" style="font-weight:bold">Motivo de rechazo:</label> 
                            </td>
                            <td>
