	...
	<html:text property="linkThuban" style="display:none;" styleId="linkThuban"/>
	    ...
	    <tbody>
			...
			<logic:equal value="Si" name="motivoRechazo">
				<tr>
					<td align="left" colspan="4">Motivo de rechazo:</td>
				</tr>
				<tr>
			...
			<logic:present name="showAviso">
	  		...
	  		<logic:equal value="PENDI" name="estadoRend">
			    <a href='#' onClick=showNuevoGastoPopup(); id="BotonAdd" style="margin-right: 12px; margin-top: 15px;">
			    	<img id="Add" src='./images/add2.png' title="Nuevo gasto" border='0' width="28" height="28">
			    </a>
		    	<a href='#' onClick=showNuevoGastoPopupCupon(); id="BotonAdd" style="margin-right: 12px; margin-top: 13px;">
		    		<img id="Add" src='./images/iconos/credit-card-with-plus-sign-64px.png'
		    			title="Asignar cup&oacute;n" border='0' width="34" height="34">
	 	    	</a> 
			</logic:equal>
		</logic:notPresent>
	</html:form>
