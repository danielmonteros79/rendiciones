...
<div class="container py-5">
	...
	<div class="row">
		<div class="col-sm-12 mb-md-4">
			...
			<small class="font-weight-bold">APROBACI&Oacute;N</small>
		</div>
	</div>
	...
	<div class="container py-5 text-center">
		<div class="row">
			<div class="col-sm-12">
				...
				<a href="#a" class="btn btn-primary px-5 py-3 mx-2 d-none glg-1 glg-2 glg-3 glg-4" onclick="aprobar()">
					Aprobar
				</a>
				<a href="#a" class="btn btn-primary px-5 py-3 mx-2 d-none glg-3 glg-4" onclick="observar()">
					Observar
				</a>
				<!-- <a href="#a" class="btn btn-primary px-5 py-3 mx-2 d-none glg-3 glg-4" onclick="redistribuir()">
					Redistribuir
				</a> -->
			</div>
		</div>
...
<input type="hidden" id="glg" value="<bean:write name="RendicionForm" property="glg"/>" />
...
<jsp:include page="../aprobacion/modalAprobarRendicion.jsp" />
