<div class="modal fade" id="modalObservarRendicion" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
			...
			<div class="modal-body px-3 mx-3 px-lg-3 mx-lg-5">
				<div class="row">
					<div class="col-sm-12 pb-3">
						&iquest;Est&aacute;s seguro que quer&eacute;s observar la rendici&oacute;n?
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12 pt-2 scroll-err">
						<div class="has-float-label form-group">
							<select id="modalObservarRendicionMotivo" class="form-control bg-light" required></select>
				...
				<div class="row">
					<div class="col-sm-12 pt-2 scroll-err">
						<div class="has-float-label">
							<textarea class="form-control bg-light" id="modalObservarRendicionDescripcion" placeholder="(113 caracteres)" rows="5" maxlength="113"
								required></textarea>
			...
			<div class="modal-footer px-3 mx-3 px-lg-3 mx-lg-5">
				<div class="row">
					<div class="col-sm-12">
						...
						<a href="#a" class="btn btn-info px-5 py-3 ml-2" onclick="modalObservarRendicionGuardar()">
							Guardar
						</a>
					</div>
				</div>
