			...
			<div class="modal-body px-5 mx-5">
				<div class="row px-5 mx-5">
					...
					<div class="col-sm-12 pt-1 pb-5 text-muted">
						Ingres&aacute; toda la informaci&oacute;n de detalle sobre el gasto o consumo que se realiz&oacute;.
					</div>
				</div>
				<div class="row px-5 mx-5 scroll-err">
				...
				<div class="row px-5 mx-5">
					...
					<div class="col-sm-12 pt-2 scroll-err">
						<div class="has-float-label">
							<textarea class="form-control bg-light" id="modalGastoObservaciones" placeholder="(120 caracteres)" rows="5" maxlength="120"
								required></textarea>
