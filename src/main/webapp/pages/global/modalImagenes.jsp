...
<!-- 						<li class="nav-item"> -->
<!-- 							<a class="nav-link active" id="modalImagenesNavLinkAdjuntarImagenes" data-toggle="tab" -->
<!-- 								href="#modalImagenesDivAdjuntarImagenes" role="tab"> -->
<!-- 								Adjuntar im&aacute;genes -->
<!-- 							</a> -->
<!-- 						</li> -->
						<li class="nav-item text-left">
<!-- 							<a class="nav-link" id="modalImagenesNavLinkVerImagenes" data-toggle="tab" href="#modalImagenesDivVerImagenes" role="tab"> -->
<!-- 								Ver im&aacute;genes -->
<!-- 							</a> -->
					...
					<div class="tab-content">
						<div class="tab-pane fade show active" id="modalImagenesDivAdjuntarImagenes" role="tabpanel">
							<div class="row">
								<div class="col-sm-12">
									<div class="row px-3">
							...
							<div class="row py-3">
								<div class="px-3 w-100">
									...
									<input type="file" id="modalImagenesArchivo" accept=".pdf,.tif" class="d-none" multiple onchange="modalImagenesAgregarArchivo()"/>
								</div>
							</div>
							<div class="row">
						...
						<div class="tab-pane fade" id="modalImagenesDivVerImagenes" role="tabpanel">
							<div class="row" id="modalImagenesTablaArchivosSubidosDiv">
								<div class="col-md-12 py-3 table-responsive-lg">
									<table class="table small" id="modalImagenesTablaArchivosSubidos">
										<thead>
											<tr>
												<th>NOMBRE</th>
									...
									<h5 class="font-weight-400" id="modalImagenesTablaArchivosSubidosVacia">
										La rendici&oacute;n no tiene im&aacute;genes cargadas
									</h5>
								</div>
							</div>
						</div>
