...
<div class="modal fade" id="modalRendicionFueraDePolitica" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
		...
		<div class="modal-content">
			...
			<div class="modal-body px-3 mx-3 px-lg-3 mx-lg-5">
				<div class="row px-lg-5 px-sm-2 mx-5">
					...
					<div id="modalRendicionTitle" class="col-sm-12 pt-1 pb-4 text-muted" style="text-align: center; font-size: 30px;">
				...
				<div class="row px-5 mx-5 pb-3" id="modalGastoMessageContainer">
					<div class="col-sm-12" style="text-align: center; font-size: 20px;">
						<span id="modalRendicionValidarMessage"></span>
					</div>
				</div>
			</div>
			<div class="modal-footer px-3 mx-3 px-lg-3 mx-lg-5">
				<div class="row px-5 mx-5">
					<div class="col-sm-12">
						...
						<a id="aceptarRendicionBtn" href="#a" class="btn btn-info px-5 py-3 ml-2" onclick="saveExpenseReport()">
