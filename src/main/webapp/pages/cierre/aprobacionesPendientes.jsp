		...
		<div class="row">
			<div class="col-12 py-1 col-sm-4">
				<div class="has-float-label">
					<input type="text" class="form-control text-uppercase" id="filtroUsuario" placeholder="ID" maxlength="8"/>
					<label>Usuario</label>
			...
			<div class="col-12 py-1 col-sm-4 has-float-label">
				<div class="input-group">
					<input readonly type="text" class="form-control text-uppercase bg-muted text-muted" id="filtroNombre" placeholder="Nombre" />
					<label>Nombre </label>
				</div>
			</div>
			<div class="col-12 py-1 col-sm-4 has-float-label">
			...
			<div class="col-12 py-1 col-sm-4">
				<span class="has-float-label">
					<input type="text" class="form-control text-uppercase" id="filtroMontoMin" placeholder="Monto Min" />
			...
			<div class="col-12 py-1 col-sm-4">
				<span class="has-float-label">
					<input type="text" class="form-control text-uppercase" id="filtroMontoMax" placeholder="Monto Max"/>
					<label>Monto Max</label>
				</span>
			</div>
			<div class="col-sm-4 py-1 scroll-err">
				<div class="has-float-label form-group">
					<select id="filtroMoneda" class="form-control basic-single" required></select>
...
<div class="container py-5 div-resultado" id="listadoRendicionesDivResultado">
	<div class="row">
		<div class="col-sm-12 mb-md-4">
			...
			<small class="font-weight-bold">APROBACIONES PENDIENTES</small>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12 py-3 table-responsive-lg">
			<div class="dt-container" id="aprobacionesPendientesDtContainer"></div>
		</div>
	</div>
</div>
...
<script type="text/javascript" src="static/js/cierre/aprobacionesPendientes.js"></script>
