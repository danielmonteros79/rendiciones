...
<display:table uid="row" name="rendiciones" requestURI="cierreOrdenDePago.do" id="ordenesDePagoTable" excludedParams="username password"
	...
	<display:column property="id" class="text-right" title="ID" />
	...
	<display:column property="importe" class="text-right nowrap" title="IMPORTE" />
	<display:column property="importeTarjeta" class="text-right nowrap" title="TARJETA" />
