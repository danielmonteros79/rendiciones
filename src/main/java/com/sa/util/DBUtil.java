...
public class DBUtil {
	 ...
	 * @param rs 
	 * @return true si el resultset finaliza cerrado, false en cualquier otro caso
	 */
	 ...
	 * @param rs 
	 * @return true si el PreparedStatement finaliza cerrado, false en cualquier otro caso
	 */
	 ...
	 * @param conn 
	 * @return true si la conexion finaliza cerrada, false en cualquier otro caso
	 */
