...
public class PagosService {
    ...
    public PagosService(SAMWebClient samClient) {
    ...
    public Integer altaModifGasto(String opcion, String idGast, String idRendicion, String moneda, String comprobante,
            String cmbComprobante, String comprobante1, String comprobante2, String cuit1, String cuit2, String cuit3, String tipoGasto,
            String importe, String fechaGasto, String codMotivo, String centroCosto, String cupCred, String cupDeb, String cupon,
            String descCupon, String importeCupon, String nroTarjeta, String observacionGasto) throws TransactionException {
        ...
        if (!idGast.equalsIgnoreCase("")) {
            idGast = String.format("%09d", Integer.parseInt(idGast));
            parametersExecute.put("id_gasto", idGast);
        }
        // cod motivo corresponde al codigo de gasto del combo.
        parametersExecute.put("cod_motivo", codGasto);
        parametersExecute.put("tipo_comprobante", comprobante);
        if (comprobante.equals("0006")) {
            comprobante1 = String.format("%04d", Integer.parseInt(comprobante1));
            comprobante2 = String.format("%08d", Integer.parseInt(comprobante2));
            parametersExecute.put("clave_ident", cuit1 + cuit2 + cuit3);
            parametersExecute.put("cod_sit_imp", cmbComprobante);
            parametersExecute.put("cod_pvnro_p", comprobante1);
            parametersExecute.put("nro_comprobante", comprobante2);
        ...
        manager.executeTrx(this.samClient, parametersExecute);
        Integer idGasto = (Integer) manager.getDataReturn();
        return idGasto;
    }

    public List<Cupones> getCupones(String opcion, String subTrx, String codapli, String user,
            String fechaDesde, String fechaHasta, String idRendicion, String codMotivo) throws TransactionException {
        ...
        parametersExecute.put("idrend", String.format("%016d", Integer.parseInt(idRendicion)));
    ...
    public List<Gastos> asignarCupon(String opcion, String idRendicion, String idGasto, String user, String impCuponTj, String nroTarjeta,
            String nroCuponTj, String cuponDeb, String cuponCred, String descCupon, String monedaCupon, String fechaPresentacion)
            throws TransactionException {
        log.info("Comienza llamado a trx para crear un gasto ");
        ManagerTransaction manager = new ManagerTransaction(new SU56());
        Map parametersExecute = new HashMap();
        ...
        // parametersExecute.put("cod_motivo", nroTarjeta);
        parametersExecute.put("id_user", user);
        parametersExecute.put("importe_cupon", String.format("%015d", Integer.parseInt(impCuponTj)));
        parametersExecute.put("nro_tarjeta", nroTarjeta);
        parametersExecute.put("cupon_tarjeta", String.format("%012d", Integer.parseInt(nroCuponTj)));
    ...
    public void addDescripcionObligatoria(String idRendicion, String idGasto, String codGasto, String codDetOblig, String campoTexto1,
    ...
    public List<DatosPantallaDinamica> consultaDetObligatorio(String idRendicion, String idGasto, String codMotivo, String codObserv)
            throws TransactionException {
    ...
    public Integer bajaGasto(String opcion, String idGasto, String user, String idRendicion, String codMotivo) throws TransactionException {
