...
public abstract class Transaction {
	 ...
	 *             Lanzar esta excepcion que ser capturada por la obtencion de
	 *             Sam, o al chequear el status de lo que devolvio la consulta a
	 *             host. Se deber manejar a travez del getMessage().
	 */
	 ...
	 * 
	 * @param parameters
	 *            String[] -> Vector de parametros de entrada.
	 * 
	 * @throws TransactionException
	 *             Lanzar esta excepcion que ser capturada por la obtencion de
	 *             Sam, o al chequear el status de lo que devolvio la consulta a
	 ...
	 * 
	 * @param parameters
	 *            String[] -> Vector de parametros de entrada para ejecucion de
	 *            trx.
	 * 
	 ...
	 * 
	 * @param trxExecute
	 *            String -> Nombre con el que se llamara a la trx en
	 *            soaConectores.
	 * 
	 * @param parametersExecute
	 *            Map -> hashMap con los parametros de entrada a la transaccion.
	 * 
	 * @throws Exception
	 *             Lanzar la exeption al chequear el status o si hay algun
	 *             problema con sam.
	 */
...
//				// TODO: handle exception
	 ...
	 * con el xml y devuelve si hay error interno con SAM o si ocurri algn
	 * error con la Trx internamente.
	 * 
	 * @param parameters
	 * 
	 * @throws Exception
