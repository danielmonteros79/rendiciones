...
public class RendicionesService {
    ...
    public List<ComboMotivo> getMotivoRendiciones(String opcion, String user) throws TransactionException {
    ...
    public String altaRendicion(String idusr, String nombreUsr, String motivo, String feDesde, String feHasta, String descripcion)
    ...
    public List<Gastos> getGastos(String idRendicion, String idGasto, String idUser, String codMotivo) throws TransactionException {
    ...
    public String bajaRendicion(String opcion, String user, String idRendicion) throws TransactionException {
