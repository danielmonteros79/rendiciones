...
public class SU51 extends Transaction {
	...
	protected void mapData(Map<String, Object> parametersExecute) {
	    ...
	    switch (opcion) {
	        case 1:
	            break;
	        case 2:
	            processOption2(lista);
	            break;
	        case 3:
	            processTipoGasto(lista);
	            break;
	        case 4:
	        case 8:
	        case 9:
	...
	private void processOption2(List<?> lista) {
	    for (Object obj : lista) {
	        String str = getStrLista(obj);
	        ComboOpcion2 comboOpcion2 = new ComboOpcion2();
	        comboOpcion2.setId(str.substring(10, 14));
	        comboOpcion2.setDescripcion(str.substring(14));
	        if (str.substring(10, 14).trim().matches("ARS|EUR|USD")) {
	...
	private void processTipoGasto(List<?> lista) {
	    for (Object obj : lista) {
	        String str = getStrLista(obj);
	        ComboGasto comboTipoGasto = new ComboGasto();
	        if (str.length() <= 54) {
	            comboTipoGasto.setId(str);
	            comboTipoGasto.setDescripcion(str.substring(4));
	        } else {
	            String detalleId = str.substring(0, str.length()) + (str.substring(54, 59).isEmpty() || str.substring(54, 59).equals("00000") ? "N" : "S");
	            comboTipoGasto.setId(detalleId);
	...
	private void processMotivo(List<?> lista) {
	    if (lista != null) {
	        for (Object obj : lista) {
	            String str = getStrLista(obj);
	            ...
	            comboMotivo.setCostosDestino(str.substring(54));
