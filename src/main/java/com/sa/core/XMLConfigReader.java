...
public class XMLConfigReader {
     ...
     * desarrollo local.
     *
     * @throws ImposibleLeerXMLException si ocurre algun error al acceder al
     * sistema de archivos o cuando el archivo de configuracion tiene un formato
     * incorrecto.
     */
     ...
     *
     * @param request HttpServletRequest para poder leer desde el contexto de la
     * aplicacion
     * @throws ImposibleLeerXMLException si ocurre algun error al acceder al
     * sistema de archivos o cuando el archivo de configuracion tiene un formato
     * incorrecto. Tambien se tira si se esta en ambiente de desarrollo.
     */
