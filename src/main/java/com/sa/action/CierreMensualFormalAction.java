...
public class CierreMensualFormalAction extends RestriccionTransaccionAction {
	...
	// ParametrosSUM paramsSUM
		...
		try {
			...
			log.info("se llama al service para el cierre mensual formal con el usuario:"+user.getIdUser());
			...
			service.GenerarPagoMarca(ParamsConstants.PAGOS_OPCION,
					...
					ParamsConstants.PAGOS_TIPOPROCESOCIERREMENSUALFORMAL, feHoy,
			...
			request.setAttribute("messageModifTCJP",
					"OK: SE COLOCO LA MARCA DE CIERRE MENSUAL FORMAL CORRECTAMENTE  "
