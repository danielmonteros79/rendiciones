...
public class ReactivacionSuspensosAction extends RestriccionTransaccionAction {
	...
	// ParametrosSUM paramsSUM
		...
		try {
			...
			log.info("se llama al service para reactivar los suspensos con el usuario:"+user.getIdUser());
			...
			service.GenerarPagoMarca(ParamsConstants.PAGOS_OPCION,
					...
					ParamsConstants.PAGOS_TIPOPROCESOREACTIVACIONSUSPENSOS, feHoy,
			...
			request.setAttribute("messageModifTCJP",
					"OK: SE COLOCO LA MARCA DE REACTIVACION DE SUSPENSOS CORRECTAMENTE  "
