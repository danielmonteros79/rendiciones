...
public class CierreMensualSimuladoAction extends RestriccionTransaccionAction {
    ...
    public ActionForward executeAction(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            service.GenerarPagoMarca(ParamsConstants.PAGOS_OPCION,
                    ...
                    ParamsConstants.PAGOS_TIPOPROCESOCIERREMENSUALSIMULADO, feHoy,
            ...
            request.setAttribute("messageModifTCJP",
                    "OK: SE COLOCO LA MARCA DE CIERRE MENSUAL SIMULADO CORRECTAMENTE "
            );
