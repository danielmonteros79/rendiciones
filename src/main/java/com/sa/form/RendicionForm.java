...
public class RendicionForm extends ActionForm {
	...
	private String gastoFechaMin;
	private String gastoFechaMax;
	...
	public void reset() {
		...
		this.gastoFechaMin = null;
		this.gastoFechaMax = null;
	}
	...
	public String getGastoFechaMin() {
		return gastoFechaMin;
	}

	public void setGastoFechaMin(String gastoFechaMin) {
		this.gastoFechaMin = gastoFechaMin;
	}

	public String getGastoFechaMax() {
		return gastoFechaMax;
	}

	public void setGastoFechaMax(String gastoFechaMax) {
		this.gastoFechaMax = gastoFechaMax;
	}
}