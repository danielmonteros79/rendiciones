...
class ComboGenericoTest {

    private ComboGenerico entity = new ComboGenerico();

    @BeforeEach
    void setup(){
        entity = new ComboGenerico("","");
    ...
    @Test
    @DisplayName("Testeando getGastos")
    void getGastos() {
        assertNull(entity.getGastos());
    }
