...
class CierreMensualFormalActionTest {
    @Mock
    Logger log;
    @Mock
    ...
    @InjectMocks
    CierreMensualFormalAction cierreMensualFormalAction;
    ...
    void executeAction(Usuario user, String res, ActionForward ret) throws Exception {
        ...
        try(MockedConstruction<CierreService> mock = Mockito.mockConstruction(CierreService.class, (mockCierreService, context) -> {
            ...
            ActionForward result = cierreMensualFormalAction.executeAction(actionMapping, actionForm, samWebApplication, samWebClient, httpServletRequest, httpServletResponse);
            assertAll(
