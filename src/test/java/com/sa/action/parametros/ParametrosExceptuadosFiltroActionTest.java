...
class ParametrosExceptuadosFiltroActionTest {
  ...
  public static Stream<Arguments> executeActionSource() {
    ...
    parametrosExceptuadosFiltroForm.setExceptuadoFiltro("24");
    parametrosExceptuadosFiltroForm.setMotivoUsuario("motivo");

    ParametrosExceptuadosFiltroForm parametrosExceptuadosFiltroFormUsuario = new ParametrosExceptuadosFiltroForm();
    parametrosExceptuadosFiltroFormUsuario.setExceptuadoFiltro("24");
    parametrosExceptuadosFiltroFormUsuario.setMotivoUsuario("usuario");
    ...
    return Stream.of(
        ...
        Arguments.of(actionMapping, samWebApplication, samWebClient, request, parametrosExceptuadosFiltroFormUsuario, usuario, parametroExceptuadoList)
                    );
  }
  ...
  void shouldDetermineWhatActionExecute(ActionMapping actionMapping, SAMWebApplication samApplication, SAMWebClient samClient, MockHttpServletRequest request,
    ...
    try (MockedConstruction<ParametrosService> parametrosServiceMC = Mockito.mockConstruction(ParametrosService.class,
      ...
      //then
      ActionForward actionForwardToAssert = parametrosExceptuadosFiltroAction.executeAction(actionMapping, parametrosExceptuadosFiltroForm, samApplication, samClient, request, httpServletResponse);
