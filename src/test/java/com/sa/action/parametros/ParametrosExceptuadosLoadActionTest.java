...
class ParametrosExceptuadosLoadActionTest {

  @Mock
  HttpServletResponse httpServletResponse;

  @InjectMocks
  ParametrosExceptuadosLoadAction parametrosExceptuadosLoadAction;
  ...
  void shouldDetermineWhatActionExecute(ActionMapping actionMapping, SAMWebApplication samApplication, SAMWebClient samClient, MockHttpServletRequest request,
    ...
    try (MockedConstruction<ParametrosService> parametrosServiceMC = Mockito.mockConstruction(ParametrosService.class,
      ...
      //then
      ActionForward actionForwardToAssert = parametrosExceptuadosLoadAction.executeAction(actionMapping, parametrosExceptuadosFiltroForm, samApplication, samClient, request,
          httpServletResponse);
