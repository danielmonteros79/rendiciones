...
class CierreTarjetaActionTest {
  /**
   * Method under test: {@link CierreTarjetaAction#executeAction(ActionMapping, ActionForm, SAMWebApplication, SAMWebClient, HttpServletRequest, HttpServletResponse)}
   */
  @Test
  ...
  void testExecuteAction() throws Exception {
    // Arrange
    CierreTarjetaAction cierreTarjetaAction = new CierreTarjetaAction();
    ...
    // Act
    cierreTarjetaAction.executeAction(mapping, form, samApplication, samClient, request, new MockHttpServletResponse());
  }
}
