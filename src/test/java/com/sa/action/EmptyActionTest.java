...
class EmptyActionTest {
    ...
    @DisplayName("Testeando exceute action")
    void executeAction(MockHttpServletRequest request, ActionMapping mapping) throws Exception {
        ActionForward result = emptyAction.executeAction(mapping, null, request, null);
